 ...
 */
public class GDNConstants {

    public static final String ACTION_REJECT = "com.demandnow.amigos.intents.ACTION_REJECT";
    public static final String ACTION_ACCEPT = "com.demandnow.amigos.intents.ACTION_ACCEPT";
